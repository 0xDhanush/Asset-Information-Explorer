...
// Structure to store asset information #[contracttype] #[derive(Clone)]
...
// Mapping asset code to AssetInfo #[contracttype]
pub enum AssetBook {
Asset(String)
}
...
contract ID - CA5OJJIVJX45T5MSSCV7BOOUIF5Z5ICZK2G5KFQGVEVJPIEFCIKYA2U2
![alt text](<Screenshot 2025-11-13 162010.png>)
